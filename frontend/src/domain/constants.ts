/**
 * Constantes métier pour l'aquaculture.
 *
 * Ces constantes sont utilisées pour la validation UX et l'affichage.
 * Les règles métier RÉELLES sont dans le backend Django.
 */

/**
 * Espèces de poissons supportées.
 */
...
/**
 * Plages optimales de paramètres environnementaux (pour affichage UX).
...
/**
 * Durées typiques de cycle (en jours).
 */
