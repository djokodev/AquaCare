...
export function ProductCard({ product, displayName, proteinLabel, quickAddLabel, onPress, onQuickAdd }: ProductCardProps) {
  return (
    <Card variant="outlined" style={styles.card}>
      <Pressable accessibilityRole="button" accessibilityLabel={displayName} onPress={onPress} style={styles.content}>
        ...
        <View style={styles.details}>
          ...
          <View style={styles.nameRow}>
            <AppText variant="bodyStrong" numberOfLines={1} style={styles.name}>{displayName}</AppText>
...
const styles = StyleSheet.create({
  card: { flexDirection: 'row', alignItems: 'stretch', gap: spacing[3] },
  ...
  actions: { width: sizing.touchTargetMinimum, justifyContent: 'space-between', alignItems: 'center' },
});
