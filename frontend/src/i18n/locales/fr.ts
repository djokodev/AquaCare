export const fr = {
  ...
  createFarmFingerlingsMaxProduction: 'Capacité maximale du cycle : {{max}} alevins',
  createFarmFingerlingsCoherenceOk: '{{count}} alevins pour ce cycle, capacité respectée ✓',
  createFarmFingerlingsCoherenceWarn: '{{count}} alevins pour ce cycle, proche de la limite',
  createFarmFingerlingsCoherenceError: '{{count}} alevins pour ce cycle dépasse la limite',
