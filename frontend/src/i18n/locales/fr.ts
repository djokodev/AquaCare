export const fr = {
  ...
  createFarmStockingDensityOk: 'Densité du cycle : {{density}}/{{unit}}, dans la norme (max {{max}}/{{unit}})',
  createFarmStockingDensityWarn: 'Densité du cycle trop élevée : {{density}}/{{unit}}, maximum {{max}}/{{unit}}',
  createFarmStockingDensityError: 'La densité du cycle dépasse la capacité maximale de votre infrastructure.',
