export const fr = {
  ...
  createFarmOtherCostsLabel: 'Autres charges annuelles (FCFA)',
  createFarmOtherCostsPlaceholder: 'Ex : 50000',
  createFarmFingerlingsCountLabel: "Nombre d'alevins (total annuel)",
  createFarmFingerlingsCountPlaceholder: 'Ex : 30000',
  createFarmFingerlingsCountSuggestion: '{{total}} alevins serait idéal pour votre capacité',
  createFarmFingerlingsCountSuggestionTarget: '{{total}} alevins pour atteindre {{target}} kg/an',
  createFarmFingerlingsCountSuggestionCapped: '{{total}} alevins max pour votre infrastructure, objectif {{target}} kg/an non atteignable',
  createFarmFingerlingsMaxProduction: 'Production max estimée : {{max}} kg/an',
  createFarmFingerlingsCoherenceOk: 'Cohérent avec votre objectif de {{target}} kg/an ✓',
  createFarmFingerlingsCoherenceWarn: 'Objectif {{target}} kg/an, légèrement sous-estimé',
  createFarmFingerlingsCoherenceError: 'Impossible d\'atteindre {{target}} kg/an avec ces alevins',
  createFarmStockingDensityOk: 'Densité : {{density}}/{{unit}}, dans la norme (max autorisé : {{max}}/{{unit}})',
  createFarmStockingDensityWarn: 'Densité trop élevée : {{density}}/{{unit}}, le maximum autorisé est {{max}}/{{unit}}, risque de mortalité élevée',
  ...
  simulationTitle: 'Votre simulation de production',
  simulationSubtitle: 'Basé sur vos données, modifiez et recalculez à tout moment.',
  simulationAnnualSummary: 'Résumé annuel',
  simulationProductionTarget: 'Production cible',
  simulationRevenue: "Chiffre d'affaires estimé",
  simulationFeedCost: 'Coût total aliment',
  simulationFingerlingsCost: 'Coût alevins',
  simulationOtherCosts: 'Autres charges',
  simulationNetProfit: 'Bénéfice estimé',
  simulationROI: 'ROI estimé',
  ...
  simulationRythmTitle: 'Rythme de production',
  simulationCycles2Fixed: '2 cycles / an  →  {{kg}} kg / cycle',
  simulationCapacityWarning: '⚠ Dépasse la capacité estimée de vos infrastructures (max {{max}} kg / cycle)',
  simulationCycleDetail: 'Détail par cycle',
  simulationFeedBags: "Sacs d'aliment nécessaires",
  simulationFeedCostPerCycle: 'Coût aliment / cycle',
  simulationDuration: 'Durée estimée',
