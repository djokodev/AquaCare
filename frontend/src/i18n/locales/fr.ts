export const fr = {
  ...
  createFarmFingerlingsCountSuggestion: 'Jusqu’à {{max}} alevins pour ce cycle',
  createFarmFingerlingsMaxProduction: 'Votre infrastructure accepte environ {{max}} alevins pour ce cycle.',
  createFarmFingerlingsCoherenceOk: '{{count}} alevins pour ce cycle, capacité respectée ✓',
  createFarmFingerlingsCoherenceWarn: 'Votre infrastructure accepte environ {{max}} alevins pour ce cycle. Vous avez saisi {{count}}.',
  ...
  createFarmCapacityNearMax: 'Capacité presque maximale.',
  ...
  simulationCalculationAssumptionsTitle: 'Hypothèses de calcul',
  simulationFeedCostAssumption: "Le coût de l'aliment est calculé à partir des phases de croissance et des sacs DIBAQ.",
  simulationFeedBagsAssumption: 'Le nombre de sacs dépend des besoins par phase et des formats disponibles.',
  ...
  simulationOtherCostsRateNote: 'Les autres charges représentent {{rate}} % du chiffre d’affaires estimé.',
