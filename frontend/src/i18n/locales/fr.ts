export const fr = {
  ...
  feedingPlanUnitScreenDescription: 'Ce plan d\'alimentation s’applique uniquement à {{unitName}}.',
  feedingPlanUnableToLoad: 'Impossible de charger le plan d\'alimentation',
  generateUnitFeedingPlan: 'Générer le plan d\'alimentation de l\'unité',
  generateUnitFeedingPlanConfirm: 'Générer un nouveau plan d\'alimentation pour cette unité ?',
