export const fr = {
  ...
  harvestDatetimeBeforeSession: "La récolte ne peut pas précéder le début de la session.",
  ...
  finalHarvestPendingMessage: 'La récolte est enregistrée, mais certaines opérations offline doivent encore être synchronisées pour confirmer le stock final.',
