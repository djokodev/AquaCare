export const fr = {
  ...
  createFarmSpeciesLabel: 'Espèce principale',
  createFarmSpeciesTilapia: 'Tilapia',
  createFarmSpeciesClarias: 'Silure (Clarias)',
  ...
  createFarmSellingPricePlaceholder: 'Ex : 1800',
  ...
  simulationFingerlingsCoast: 'Coût alevins',
  ...
  simulationAquacareFeeDesc: '20 FCFA × {{kg}} kg = {{amount}} FCFA / an',
  simulationChooseCycles: 'Choisissez votre rythme',
  simulationCyclesOption2: '2 cycles / an  →  {{kg}} kg / cycle  (~{{days}} j)',
  simulationCyclesOption3: '3 cycles / an  →  {{kg}} kg / cycle  (~{{days}} j)',
  ...
  myFeedOrderRemainingBtn: 'Commander les {{count}} sacs restants',
