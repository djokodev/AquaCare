export const en = {
  ...
  feedingPlanUnitScreenDescription: 'This feeding plan applies only to {{unitName}}.',
  feedingPlanUnableToLoad: 'Unable to load the feeding plan',
  generateUnitFeedingPlan: 'Generate the unit feeding plan',
  generateUnitFeedingPlanConfirm: 'Generate a new feeding plan for this unit?',
