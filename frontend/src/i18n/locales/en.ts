export const en = {
  ...
  createFarmFingerlingsMaxProduction: 'Your infrastructure supports about {{max}} fingerlings for this cycle.',
  createFarmFingerlingsCoherenceOk: '{{count}} fingerlings for this cycle, capacity respected ✓',
  createFarmFingerlingsCoherenceWarn: 'Your infrastructure supports about {{max}} fingerlings for this cycle. You entered {{count}}.',
  ...
  createFarmCapacityNearMax: 'Capacity is almost maxed out.',
  ...
  simulationCalculationAssumptionsTitle: 'Calculation assumptions',
  simulationFeedCostAssumption: 'Feed cost is calculated from growth phases and DIBAQ feed bags.',
  simulationFeedBagsAssumption: 'Feed bags are computed from phase needs and available bag sizes.',
