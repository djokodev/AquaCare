export const en = {
  ...
  createFarmSpeciesLabel: 'Main species',
  createFarmSpeciesTilapia: 'Tilapia',
  createFarmSpeciesClarias: 'Catfish (Clarias)',
  ...
  createFarmSellingPricePlaceholder: 'E.g. 1800',
  ...
  simulationFingerlingsCoast: 'Fingerlings cost',
  ...
  simulationAquacareFeeDesc: '20 FCFA × {{kg}} kg = {{amount}} FCFA / year',
  simulationChooseCycles: 'Choose your pace',
  simulationCyclesOption2: '2 cycles / year  →  {{kg}} kg / cycle  (~{{days}} d)',
  simulationCyclesOption3: '3 cycles / year  →  {{kg}} kg / cycle  (~{{days}} d)',
  ...
  myFeedOrderRemainingBtn: 'Order the {{count}} remaining bags',
