export const en = {
  ...
  createFarmOtherCostsLabel: 'Other annual costs (FCFA)',
  createFarmOtherCostsPlaceholder: 'E.g. 50000',
  createFarmFingerlingsCountLabel: 'Number of fingerlings (annual total)',
  createFarmFingerlingsCountPlaceholder: 'E.g. 30000',
  createFarmFingerlingsCountSuggestion: '{{total}} fingerlings would be ideal for your capacity',
  createFarmFingerlingsCountSuggestionTarget: '{{total}} fingerlings to reach {{target}} kg/year',
  createFarmFingerlingsCountSuggestionCapped: '{{total}} fingerlings max for your infrastructure, {{target}} kg/year target not achievable',
  createFarmFingerlingsMaxProduction: 'Estimated max production: {{max}} kg/year',
  createFarmFingerlingsCoherenceOk: 'Consistent with your target of {{target}} kg/year ✓',
  createFarmFingerlingsCoherenceWarn: 'Target {{target}} kg/year, slightly underestimated',
  createFarmFingerlingsCoherenceError: 'Cannot reach {{target}} kg/year with these fingerlings',
  createFarmStockingDensityOk: 'Density: {{density}}/{{unit}}, within norm (max allowed: {{max}}/{{unit}})',
  createFarmStockingDensityWarn: 'Density too high: {{density}}/{{unit}}, maximum allowed is {{max}}/{{unit}}, risk of high mortality',
  ...
  simulationTitle: 'Your production simulation',
  simulationSubtitle: 'Based on your data, edit and recalculate at any time.',
  simulationAnnualSummary: 'Annual summary',
  simulationProductionTarget: 'Production target',
  simulationRevenue: 'Estimated revenue',
  simulationFeedCost: 'Total feed cost',
  simulationFingerlingsCost: 'Fingerlings cost',
  simulationOtherCosts: 'Other costs',
  simulationNetProfit: 'Estimated profit',
  simulationROI: 'Estimated ROI',
  ...
  simulationRythmTitle: 'Production pace',
  simulationCycles2Fixed: '2 cycles / year  →  {{kg}} kg / cycle',
  simulationCapacityWarning: '⚠ Exceeds your infrastructure capacity (max {{max}} kg / cycle)',
  simulationCycleDetail: 'Per cycle breakdown',
  simulationFeedBags: 'Feed bags needed',
  simulationFeedCostPerCycle: 'Feed cost / cycle',
  simulationDuration: 'Estimated duration',
