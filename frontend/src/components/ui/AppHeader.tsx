...
export function AppHeader({ title, subtitle, variant = 'brand', onBack, backLabel, rightAction, backTestID }: AppHeaderProps) {
  ...
  return (
    <View style={[styles.header, { paddingTop: insets.top + spacing[2] }, brand ? styles.brand : styles.surface]}>
...
const styles = StyleSheet.create({
  ...
  brand: { backgroundColor: colors.brand.primary },
  surface: { backgroundColor: colors.surface.card, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.border.subtle },
