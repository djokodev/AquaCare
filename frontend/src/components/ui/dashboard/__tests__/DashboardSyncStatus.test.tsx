    ...
    t: (key: string, options?: { count?: number; date?: string }) => {
      ...
      const labels: Record<string, Record<string, string>> = {
        fr: {
          ...
          dashboardSyncMinutesAgo_one: `Données synchronisées il y a ${count} min`,
          dashboardSyncMinutesAgo_other: `Données synchronisées il y a ${count} min`,
          dashboardSyncHoursAgo_one: `Dernière synchronisation il y a ${count} h`,
          dashboardSyncHoursAgo_other: `Dernière synchronisation il y a ${count} h`,
        ...
        en: {
          ...
          dashboardSyncMinutesAgo_one: `Data synced ${count} min ago`,
          dashboardSyncMinutesAgo_other: `Data synced ${count} min ago`,
          dashboardSyncHoursAgo_one: `Last synced ${count} hour ago`,
          dashboardSyncHoursAgo_other: `Last synced ${count} hours ago`,
