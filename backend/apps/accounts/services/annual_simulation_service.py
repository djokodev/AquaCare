"""
Service de simulation annuelle de production piscicole AquaCare.
...
class AnnualSimulationService:
    ...
    def simulate(
        ...
        production_per_cycle_kg = annual_production_target_kg / num_cycles
        ...
        # Lazy import pour éviter les imports circulaires accounts ↔ commerce
        from commerce.services.cycle_simulation_service import CycleSimulationService  # noqa: PLC0415

        # Simulation par cycle (réutilise CycleSimulationService)
        ...
        summary_one_cycle = cycle_sim['summary']
        feed_cost_per_cycle = summary_one_cycle['feed_cost_fcfa']
