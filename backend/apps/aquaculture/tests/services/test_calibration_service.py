...
class TestCalibrationService:
    ...
    def test_first_calibration_conserves_stock(self, production_cycle):
        ...
        assert (source.current_count, source.current_biomass, source.current_average_weight) == (
            800,
            Decimal("70.00"),
            Decimal("87.50"),
        )
        assert (operation.destination_cycle.current_count, operation.destination_cycle.current_biomass) == (
            200,
            Decimal("30.00"),
        )
