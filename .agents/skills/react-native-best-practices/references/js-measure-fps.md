...
## AquaCare Testing Scenarios

### Scenarios to Measure

1. **List Scrolling**: Scroll through cycles list rapidly
2. **Dashboard Load**: Navigate to dashboard, measure initial render
3. **Form Input**: Type rapidly in daily log form
4. **Navigation**: Transition between screens

### Target Metrics

| Screen | Target FPS | Action |
|--------|------------|--------|
| Dashboard | 55-60 | Scroll stats cards |
| Cycles List | 55-60 | Fast scroll |
| Daily Log Form | 60 | Rapid typing |
| Product Catalog | 55-60 | Filter/search |
