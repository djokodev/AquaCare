...
Lists to optimize in AquaCare:
- **CyclesList**: Production cycles on dashboard
- **DailyLogsList**: History of daily logs
- **ProductCatalog**: Store products
- **NotificationsList**: User notifications
